...
rule evaluation:
    input:
        ...
        callset  = config["HEAD_DIR"] + "/data/variant_calling/callset.freebayes.normalized.sorted.vcf.gz",
        callidx  = config["HEAD_DIR"] + "/data/variant_calling/callset.freebayes.normalized.sorted.vcf.gz.tbi"
    params:
        prefix = config["HEAD_DIR"] + "/data/evaluation/freebayes"
    output:
